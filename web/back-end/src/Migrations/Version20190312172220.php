...
final class Version20190312172220 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pfmrule (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, application_level INT NOT NULL, rule VARCHAR(255) NOT NULL, INDEX IDX_DAC6458312469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pfmrule ADD CONSTRAINT FK_DAC6458312469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pfmrule DROP FOREIGN KEY FK_DAC6458312469DE2');
