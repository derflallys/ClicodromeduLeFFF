...
\textbf{ajouter une combinaison } \textbf{Priorité : 1} \\ Les combinaisons de règle ce sont  toutes les tags qui convient avec la catégorie de chaque mot, ces combinaisons est géré par les utilisateurs qui doivent les ajouter d'une façon cohérente.
