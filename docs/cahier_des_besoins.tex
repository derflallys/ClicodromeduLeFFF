...
\subsection{Java}
\includegraphics[width=2cm]{http://www.igmcentre.fr/wp-content/uploads/2016/03/logo-java-PNG-500x325.png}
...
\subsection{PHP}
\includegraphics[width=2cm]{https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/PHP-logo.svg/1280px-PHP-logo.svg.png}
...
\subsection{JQuery}
\includegraphics[width=2cm]{http://pluspng.com/img-png/jquery-logo-vector-png-download-free-jquery-vector-logo-500.jpg}
\subsection{CSS}
\includegraphics[width=2cm]{https://upload.wikimedia.org/wikipedia/commons/d/d5/CSS3_logo_and_wordmark.svg}
\section{Références}
