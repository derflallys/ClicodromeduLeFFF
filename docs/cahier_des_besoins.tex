...
Le LeFFF (Lexique Électronique des Formes Fléchies du Français) obtenu par une nouvelle technique pour la construction de lexiques morphologiques à large couverture. Elle repose sur l'idée d'associer à chaque forme, une règle, ses traits morphologiques et d'autres champs.
...
Le LeFFF est un lexique de formes fléchies et ce n'est donc pas une simple liste de mots, mais une ressource complexe constituée de :
\begin{itemize}  
