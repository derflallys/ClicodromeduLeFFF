...
- Implémentation du PFM c'est à dire on doit implémenté des règles pour que le compilateur puisse générer les formes fléchies des mots.    \\
...
On va donner juste un exemple de deux cas d'utilisation:\\
\begin{itemize}
\item \bf L'administrateur: \\
\item \bf Le visiteur: \\
\end{itemize}
...
\begin{tabularx}{\textwidth}{|l|c|X|}
  ...
  \hline
  \hline
  Capture des besoins fonctionnels :& 18/01/2019 & 07/02/2019
  \\ 
   \hline
    \hline
     \hline
 ...
 \hline
  \hline
  Analyse et conception :& 28/01/2019 & 01/02/2019
  \\ 
   \hline
  \hline
   \hline
...
Codage et test: & 04/02/2019 &  03/04/2019
    \\
      \hline
       \hline
        \hline
...
Rédaction du Rapport: & 05/03/2019 &  05/04/2019
  \\
  \hline
   \hline
    \hline
...
\includegraphics[width=17cm]{Ganttdiag.PNG}
